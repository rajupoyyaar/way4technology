                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={3} sm={6} className="xs:mb-[25px]">
                            ...
                            <div><i className="feather-phone-call text-sm mr-[10px] text-themecolor"></i>7845315923</div>
                            <div><i className="feather-mail text-sm mr-[10px] text-themecolor"></i><a aria-label="mail" href="mailTo:way4technology@gmail.com">way4technology@gmail.com</a></div>
                        </Col>
                        <Col lg={3} sm={6}>
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="flex justify-center items-center text-center sm:mb-[20px]">
                            <p className="mb-0">&copy; 2024 way4Technology</p>
                        </Col>
